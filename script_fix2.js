...
const startIdx = content.indexOf('let dbPass: any = null;');
const endIdx = content.indexOf('// --- PLANTILLA');
content = content.slice(0, startIdx) + replacementTop + content.slice(endIdx + 16);
